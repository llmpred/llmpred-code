...
# csv files
path_curr = Path.cwd()
path_max_val = path_curr.parent.__str__() + '/data/data_1_input_data'
path_llm_out = path_curr.parent.__str__() + '/data/data_2_output_data'
path_llm_post_processed = path_curr.parent.__str__() + '/data/data_3_llm_post_processed'
